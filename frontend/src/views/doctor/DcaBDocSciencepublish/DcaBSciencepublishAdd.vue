    ...
    <a-card title="论文信息" v-if="isShow" :headStyle="{
          ...
          ><a-col :span="7" :offset="1">
            <a-form-item label="收录情况">
              ...
              >
                ...
                <a-select-option value="SCIE"> SCIE </a-select-option>
          ...
          ><a-col :span="7" :offset="1">
            <a-form-item label="影响因子">
              <a-input
                ...
                placeholder="请输入影响因子"
                v-decorator="['paperCause',{ rules: [{ required: true, message: '影响因子不能为空' }] }]"
              /> </a-form-item></a-col></a-row
        ><a-row
          ><a-col :span="7">
          ...
          ><a-col :span="7" :offset="1">
            <a-form-item label="期刊类型">
              <a-select
                placeholder="请输入期刊类型"
                v-decorator="['wzlx',{ rules: [{ required: true, message: '期刊类型不能为空' }] }]"
                style="width: 100%"
              >
          ...
          <a-col :span="7" >
           <a-form-item label="第一或通讯作者">
               <a-select
                ...
                v-decorator="[
                  'authorRank',
                  { rules: [{ required: true, message: '第一或通讯作者不能为空' }] }
                ]"
              >
           ...
           <a-col :span="7" :offset="1">
             <a-form-item label="第一作者或通讯作者共几人">
              ...
              @change="changeAuditTotalnum"
                ...
                v-decorator="['auditTotalnum', { rules: [{ required: true, message: '第一作者或通讯作者共几人不能为空' }] }]"
              /> </a-form-item
          >
          </a-col
          >
          <a-col :span="7" :offset="1">
            <a-form-item label="排第几">
              <a-input-number
                ...
                @change="changeDjzz"
                placeholder="请输入排第几"
                v-decorator="['djzz',{ rules: [{ required: true, message: '排第几不能为空' }] }]"
              /> </a-form-item
          ></a-col>
      ...
      <a-col :span="7" >
           <a-form-item label="文章类型">
              <a-select
                placeholder="文章类型"
                v-decorator="['jxzcsl',{ rules: [{ required: true, message: '文章类型不能为空' }] }]"
                @change="changeWzlx"
              >
          ...
          >  <a-col :span="7" :offset="1">
           <a-form-item label="文章分数">
              <a-input-number
                :disabled="true"
                placeholder="请输入文章分数"
                v-decorator="['cdzs',{ rules: [{ required: true, message: '文章分数不能为空' }] }]"
              /> </a-form-item
          ></a-col
          >
          <a-col :sm="7" :offset="1">
             <a-form-item label="第一作者第一单位">
              <a-input
                ...
                v-decorator="['firstUnitAuthor',{ rules: [{ required: true, message: '第一作者第一单位不能为空' }] }]"
              /> </a-form-item
          >
          </a-col>
        </a-row>
         <a-row>
          <a-col :span="7" >
            <a-form-item label="期刊JCR分区">
               <a-select
                placeholder="请输入期刊JCR分区"
                v-decorator="['auditQkjb',{ rules: [{ required: true, message: '期刊JCR分区不能为空' }] }]"
                style="width: 100%"
              >
