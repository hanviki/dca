...
public class DcaBDocSciencesearchServiceImpl extends ServiceImpl<DcaBDocSciencesearchMapper, DcaBDocSciencesearch> implements IDcaBDocSciencesearchService {
    ...
    public IPage<DcaBDocSciencesearch> findDcaBDocSciencesearchs(QueryRequest request, DcaBDocSciencesearch dcaBDocSciencesearch) {
        try {
            ...
            if (dcaBDocSciencesearch.getIsDeletemark() != null && dcaBDocSciencesearch.getIsDeletemark().equals(1)) {
                queryWrapper.apply(" dca_b_doc_sciencesearch.user_account in (\n" +
                        "select user_account  from dca_b_doc_user  where  IFNULL(cz_date,'9999-01-01')  >= dca_b_doc_sciencesearch.auditDate2 and dca_b_doc_sciencesearch.auditDate2 >= IFNULL(in_date,'1900-01-01') )");
            }
            if (dcaBDocSciencesearch.getIsDeletemark() != null && dcaBDocSciencesearch.getIsDeletemark().equals(2)) {
                queryWrapper.apply(" dca_b_doc_sciencesearch.user_account in (\n" +
                        "select user_account  from dca_b_doc_user  where  IFNULL(cz_date,'9999-01-01')  < dca_b_doc_sciencesearch.auditDate2 or dca_b_doc_sciencesearch.auditDate2 < IFNULL(in_date,'1900-01-01') )");
            }
